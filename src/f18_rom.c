...
const f18_symbol_table_t basic_symtab  = SYMTAB_INITALIZER(basic_sym);
...
const f18_symbol_table_t serdes_boot_symtab  = SYMTAB_INITALIZER(serdes_boot_sym);
...
const f18_symbol_table_t sdram_addr_symtab  = SYMTAB_INITALIZER(sdram_addr_sym);
...
const f18_symbol_table_t sdram_control_symtab  = SYMTAB_INITALIZER(sdram_control_sym);
...
const f18_symbol_table_t sdram_data_symtab  = SYMTAB_INITALIZER(sdram_data_sym);
...
const f18_symbol_table_t eForth_bitsy_symtab  = SYMTAB_INITALIZER(eForth_bitsy_sym);
...
const f18_symbol_table_t eForth_stack_symtab  = SYMTAB_INITALIZER(eForth_stack_sym);
...
const f18_symbol_table_t sdram_mux_symtab  = SYMTAB_INITALIZER(sdram_mux_sym);
...
const f18_symbol_table_t sdram_idle_symtab  = SYMTAB_INITALIZER(sdram_idle_sym);
...
const f18_symbol_table_t analog_symtab  = SYMTAB_INITALIZER(analog_sym);
...
const f18_symbol_table_t one_wire_symtab  = SYMTAB_INITALIZER(one_wire_sym);
...
const f18_symbol_table_t sync_boot_symtab  = SYMTAB_INITALIZER(sync_boot_sym);
...
const f18_symbol_table_t spi_boot_symtab  = SYMTAB_INITALIZER(spi_boot_sym);
...
const f18_symbol_table_t async_boot_symtab  = SYMTAB_INITALIZER(async_boot_sym);
...
const f18_symbol_table_t* SymTabMap[8][18] = {
  {&basic_symtab,&serdes_boot_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&sdram_data_symtab,&sdram_control_symtab,&sdram_addr_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,},
  {&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&eForth_bitsy_symtab,&eForth_stack_symtab,&sdram_mux_symtab,&sdram_idle_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&analog_symtab,},
  {&one_wire_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,},
  {&sync_boot_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,},
  {&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,},
  {&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,},
  {&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&analog_symtab,},
  {&basic_symtab,&serdes_boot_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&spi_boot_symtab,&basic_symtab,&basic_symtab,&async_boot_symtab,&analog_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&analog_symtab,&basic_symtab,&basic_symtab,&basic_symtab,&analog_symtab,},
};
